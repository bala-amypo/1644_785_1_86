...
public class Fertilizer {
    ...
    public Fertilizer(Long id, String name, String npkRatio, String recommendedForCrops) {
        this.id = id; this.name = name; this.npkRatio = npkRatio; this.recommendedForCrops = recommendedForCrops;
    }
    ...
    public static class FertilizerBuilder {
        private Long id; private String name; private String npkRatio; private String recommendedForCrops;
        ...
        public FertilizerBuilder npkRatio(String npk) { this.npkRatio = npk; return this; }
        public FertilizerBuilder recommendedForCrops(String crops) { this.recommendedForCrops = crops; return this; }
