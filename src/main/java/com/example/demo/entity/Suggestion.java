...
public class Suggestion {
    ...
    public Suggestion(Long id, Farm farm, String suggestedCrops, String suggestedFertilizers, LocalDateTime createdAt) {
        this.id = id; this.farm = farm; this.suggestedCrops = suggestedCrops; this.suggestedFertilizers = suggestedFertilizers; this.createdAt = createdAt;
    }
    ...
    public static class SuggestionBuilder {
        ...
        public SuggestionBuilder suggestedCrops(String crops) { this.suggestedCrops = crops; return this; }
        public SuggestionBuilder suggestedFertilizers(String ferts) { this.suggestedFertilizers = ferts; return this; }
        public SuggestionBuilder createdAt(LocalDateTime dt) { this.createdAt = dt; return this; }
